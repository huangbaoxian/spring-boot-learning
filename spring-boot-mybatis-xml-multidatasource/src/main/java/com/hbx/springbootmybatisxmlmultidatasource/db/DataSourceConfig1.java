...
@Configuration
@MapperScan(basePackages = "com.hbx.springbootmybatisxmlmultidatasource.mapper.test1", sqlSessionTemplateRef = "template1")
public class DataSourceConfig1 {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("testDataSource1") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mapper/*Mapper1.xml"));
